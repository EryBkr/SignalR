...
namespace SignalR.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //SignalR ý projeye dahil ediyorum
            services.AddSignalR();

            //UI tarafýndan eriþim engelini kaldýrmak için CORS belirledik
            services.AddCors(options =>
            {
                options.AddPolicy("MyCorsPolicy", builder =>
                {
                    builder.WithOrigins("https://localhost:44349").AllowAnyHeader().AllowAnyMethod().AllowCredentials();
                    //AllowCredentials Cookie yi API a gönderme iznidir.
                });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //Belirlediðimiz CORS u projeye tanýttýk
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                //http://domain/MyHub þeklinde Socket eriþimi yapýlacaktýr
